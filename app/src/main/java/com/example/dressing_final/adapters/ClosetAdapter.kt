...
class ClosetAdapter(private val list: List<Closet>): RecyclerView.Adapter<ClosetViewHolder>() {
    /**
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ClosetViewHolder {
        ...
        return ClosetViewHolder(layoutInflater.inflate(R.layout.closet_card_template,parent,false))
    }
