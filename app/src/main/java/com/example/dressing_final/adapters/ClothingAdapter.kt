...
class ClothingAdapter(private val list: List<Clothing>): RecyclerView.Adapter<ClothingViewHolder>() {
    /**
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ClothingViewHolder {
        ...
        return ClothingViewHolder(layoutInflater.inflate(R.layout.part_of_clothes_template,parent,false))
    }
